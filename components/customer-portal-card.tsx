...
import { ExternalLink, Copy, Check, Share2, QrCode, Sparkles } from 'lucide-react';
...
export function CustomerPortalCard() {
  ...
  return (
    ...
    >
      <Card className="rounded-3xl border-0 shadow-xl overflow-hidden relative group">
        ...
        <CardContent className="space-y-5 relative">
          {/* Portal Link Display with iOS-style input */}
          ...
          {/* Instructions with iOS-style card */}
          <motion.div
